...
var navapiAPIPermissionSeeds = []apiPermissionSeed{
	...
	{Guid: "navapi-api-client-invite-settings", Name: "邀请设置", Code: "navapi.client.invite.settings", Path: "/clients/invitations/settings", Verb: "GET", Sort: 542, Group: "客户"},
	{Guid: "navapi-api-client-invite-save", Name: "保存邀请设置", Code: "navapi.client.invite.save", Path: "/clients/invitations/settings", Verb: "PUT", Sort: 543, Group: "客户"},
	{Guid: "navapi-api-client-invite-codes", Name: "邀请码列表", Code: "navapi.client.invite.codes", Path: "/clients/invitations/codes", Verb: "GET", Sort: 544, Group: "客户"},
	{Guid: "navapi-api-client-invite-code-create", Name: "创建邀请码", Code: "navapi.client.invite.code.create", Path: "/clients/invitations/code", Verb: "POST", Sort: 545, Group: "客户"},
	{Guid: "navapi-api-client-invite-code-update", Name: "更新邀请码", Code: "navapi.client.invite.code.update", Path: "/clients/invitations/code", Verb: "PUT", Sort: 546, Group: "客户"},
	{Guid: "navapi-api-client-invite-code-get", Name: "邀请码详情", Code: "navapi.client.invite.code.get", Path: "/clients/invitations/code/:id", Verb: "GET", Sort: 547, Group: "客户"},
	{Guid: "navapi-api-client-invite-code-delete", Name: "删除邀请码", Code: "navapi.client.invite.code.delete", Path: "/clients/invitations/code/:id", Verb: "DELETE", Sort: 548, Group: "客户"},
	{Guid: "navapi-api-client-invite-rel", Name: "邀请关系", Code: "navapi.client.invite.relations", Path: "/clients/invitations/relations", Verb: "GET", Sort: 549, Group: "客户"},
	{Guid: "navapi-api-client-invite-stats", Name: "邀请统计", Code: "navapi.client.invite.stats", Path: "/clients/invitations/stats", Verb: "GET", Sort: 550, Group: "客户"},
	{Guid: "navapi-api-client-checkin-settings", Name: "签到设置", Code: "navapi.client.checkin.settings", Path: "/clients/checkin/settings", Verb: "GET", Sort: 551, Group: "客户"},
	{Guid: "navapi-api-client-checkin-save", Name: "保存签到设置", Code: "navapi.client.checkin.save", Path: "/clients/checkin/settings", Verb: "PUT", Sort: 552, Group: "客户"},
	{Guid: "navapi-api-client-checkin-list", Name: "签到记录", Code: "navapi.client.checkin.list", Path: "/clients/checkin/list", Verb: "GET", Sort: 553, Group: "客户"},
	...
	{Guid: "navapi-api-card-get", Name: "兑换卡详情", Code: "navapi.card.get", Path: "/card/:id", Verb: "GET", Sort: 732, Group: "兑换卡"},
	...
	{Guid: "navapi-api-card-delete", Name: "删除兑换卡", Code: "navapi.card.delete", Path: "/card/:id", Verb: "DELETE", Sort: 736, Group: "兑换卡"},
	...
	{Guid: "navapi-api-redemption-get", Name: "兑换码详情", Code: "navapi.redemption.get", Path: "/redemption/:id", Verb: "GET", Sort: 742, Group: "兑换卡"},
	...
	{Guid: "navapi-api-redemption-delete", Name: "删除兑换码", Code: "navapi.redemption.delete", Path: "/redemption/:id", Verb: "DELETE", Sort: 746, Group: "兑换卡"},
