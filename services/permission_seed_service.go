...
var navapiAPIPermissionSeeds = []apiPermissionSeed{
	...
	{Guid: "navapi-api-provider-debug-chat", Name: "调试渠道模型对话", Code: "navapi.provider.debug.chat", Path: "/provider/debug/chat", Verb: "POST", Sort: 362, Group: "渠道"},
	{Guid: "navapi-api-provider-debug-request", Name: "调试渠道自定义请求", Code: "navapi.provider.debug.request", Path: "/provider/debug/request", Verb: "POST", Sort: 363, Group: "渠道"},
	{Guid: "navapi-api-provider-key", Name: "查看渠道密钥", Code: "navapi.provider.key", Path: "/provider/:guid/key", Verb: "GET", Sort: 364, Group: "渠道"},
	{Guid: "navapi-api-provider-key-update", Name: "更新渠道密钥", Code: "navapi.provider.key.update", Path: "/provider/:guid/key", Verb: "PUT", Sort: 365, Group: "渠道"},
	{Guid: "navapi-api-provider-get", Name: "渠道详情", Code: "navapi.provider.get", Path: "/provider/:guid", Verb: "GET", Sort: 366, Group: "渠道"},
	{Guid: "navapi-api-provider-create", Name: "创建渠道", Code: "navapi.provider.create", Path: "/provider/", Verb: "POST", Sort: 367, Group: "渠道"},
	{Guid: "navapi-api-provider-update", Name: "更新渠道", Code: "navapi.provider.update", Path: "/provider/", Verb: "PUT", Sort: 368, Group: "渠道"},
	{Guid: "navapi-api-provider-delete", Name: "删除渠道", Code: "navapi.provider.delete", Path: "/provider/:guid", Verb: "DELETE", Sort: 369, Group: "渠道"},
