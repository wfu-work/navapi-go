...
type VendorMeta struct {
	...
	ResponsesToolPolicy   string   `json:"responsesToolPolicy" gorm:"column:responses_tool_policy;size:20;default:passthrough;comment:Responses工具策略"`
	DisabledResponseTools string   `json:"disabledResponseTools" gorm:"column:disabled_response_tools;type:text;comment:禁用的Responses工具"`
