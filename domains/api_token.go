...
type ApiToken struct {
	...
	UnlimitedBalance    bool   `json:"unlimitedBalance" gorm:"column:unlimited_balance;default:false;comment:不限余额"`
	BalanceAmountMicros int64  `json:"balanceAmountMicros" gorm:"column:balance_amount_micros;default:0;comment:余额金额微单位"`
